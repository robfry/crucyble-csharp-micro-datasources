...
namespace FIDO.Datasources.FIDO.Support.Notification
{
  static class Email_Send
  {
    ...
    public static void Send(string sTo, string sCC, string sFrom, string sSubject, string sBody, List<string> lGaugeAttachment, string sEmailAttachment)
    {
      ...
      var request = API_Endpoints.PrimaryConfig.host + API_Endpoints.PrimaryConfig.fido_configs.app_configs.email;
      ...
      var request2 = API_Endpoints.PrimaryConfig.host + API_Endpoints.PrimaryConfig.fido_configs.app_configs.emailserver;
      ...
      var stringreturn2 = getREST2.RestCall(newRequest2);
